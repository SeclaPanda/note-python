...
while menu != 6: #stop for menu
    if menu == 1:
        stack_all -= stack_all[-1] #deleting last item in stack
        print(stack_all)
    elif menu == 2:
        ...
        if menu_ch == 1:
            ...
            if menu_st == 1:
                stack_1 -= stack_1[-1] #deleting last item in stack
                print(stack_1)
            elif menu_st == 2:
                stack_2 -= stack_2[-1] #deleting last item in stack
                print(stack_2)
            elif menu_st == 3:
                stack_3 -= stack_3[-1] #deleting last item in stack
                print(stack_3)
            else:
                continue
        elif menu_ch == 2:
